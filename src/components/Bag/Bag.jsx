...
const Bag = ({ bagModal, setBagModal, bag, setBag }) => {
    ...
    return (
        <section className={`${bagModal ? ' bagModalActive' : ''}  bagModal`}>
                                    ...
                                    <div className="item">
                                        ...
                                        <div className="item__content">
                                            ...
                                            <div className="item__description" id="desc">
                                                ...
                                                {/*<p>Code: NP2021</p>*/}
                                                <p data-en="Price:" data-sr="Cena:" className='text-bold'>Cena: {item.proizvod_cena} ,00rsd</p>
                                            </div>
...

                {
                    cart.cartData.length === 0 ? (
                        ...
                        <div className='shoping__bag-footer'>
                            <p className='text-bold' data-en="Total:" data-sr="Ukupno:">24000,00 rsd</p>
                            <p className='text-bold' data-en="Pieces:" data-sr="Komada:">Komada: {cart.cartData.length}</p>
                        </div>
                    )
                }
