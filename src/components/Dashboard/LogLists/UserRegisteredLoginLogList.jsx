...
const UserRegisteredLoginLogList = () => {

    const [date, setDate] = useState('');
    const [category, setcategpry] = useState('registracija');
    ...
    const handleSubmit = (e) => {
        ...
        api({
            method: 'post',
            url: 'logs.php?fun=read&lokacija=registracija',
            data: data,
        })
            .then((response) => {
...
export default UserRegisteredLoginLogList