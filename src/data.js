...
export const proizvodi = [
    {
        ...
        proizvod_tkanina: '',
        proizvod_boja: '100% cotton. No stretch',
        proizvod_odrzavanje: '',
        podk_id: 1,
    },
    {
        id: 2,
        proizvod_naziv_en: 'Woman  trousers',
        proizvod_naziv_sr: 'Ženske zvonaste kariorane pantalone',
        proizvod_opis_en: 'Woman s slim trousers made from black-white rectangular pattern cotton. ',
        proizvod_opis_sr: 'Ženske slim pantalone izrađene crno-belog kariranog pamucnog materijala.',
        proizvod_velicina: '38',
        proizvod_cena: '16990',
        slika_cela: p1Cela,
